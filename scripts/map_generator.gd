...
const COMMON_ZONE_COUNT := 5
const RARE_ZONE_COUNT := 2
const COMMON_RADIUS_MIN := 140.0
const COMMON_RADIUS_MAX := 220.0
const RARE_RADIUS_MIN := 90.0
const RARE_RADIUS_MAX := 140.0
const ZONE_MARGIN := 120.0
const ZONE_MIN_GAP := 50.0
...
const SPAWN_CLEAR_RADIUS := 260.0
